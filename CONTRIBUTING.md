...
> **Status:** pre-alpha — M0 foundations are complete (Tauri v2 skeleton, Rust
> workspace, typed IPC, CI). See [docs/ROADMAP.md](docs/ROADMAP.md) for what's next.
...
src-tauri/        # Rust workspace
  crates/         # Domain crates (engine, serial, config, …)
  src/            # Tauri application entry point
```
